...
[source,bash]
----
mvn archetype:generate -DarchetypeGroupId=com.hivemq -DarchetypeArtifactId=hivemq-extension-archetype -DarchetypeVersion=4.7.0 -DhivemqExtensionSdkVersion=4.6.2
----
